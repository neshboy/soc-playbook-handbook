# -*- coding: utf-8 -*-
"""
BOOK-INDEX.md displays each playbook's old ID in parentheses next to its
title/link. After the ID migration, those parenthetical mentions are stale.
This script updates them to the new canonical ID, matched per-line by the
playbook's file path (not by a global string replace), so the two old-ID
collision pairs (PB-NET-04, WEB-15-004) are resolved correctly rather than
both ending up with the same replacement.
Only touches lines that already show a parenthetical old ID; does not add
one where the index line previously showed no ID at all.
"""
import re

ROOT = "C:/Users/User/SOC-Playbook-Handbook/"
BOOK_INDEX = ROOT + "BOOK-INDEX.md"

# (relative_path, old_id_or_None, new_id)
MIGRATIONS = [
    ("playbooks/10-identity-ad-account/repeated-login-failures.md", None, "IAM-001"),
    ("playbooks/10-identity-ad-account/brute-force.md", "IAM-AUTH-04", "IAM-002"),
    ("playbooks/10-identity-ad-account/password-spraying.md", None, "IAM-003"),
    ...
    ("playbooks/11-identity-ad-kerberos/golden-ticket-indicators.md", None, "IAM-016"),
    ...
    ("playbooks/11-identity-ad-kerberos/dcsync.md", None, "IAM-020"),
    ...
    ("playbooks/11-identity-ad-kerberos/pass-the-ticket.md", None, "IAM-023"),
    ("playbooks/11-identity-ad-kerberos/ntlm-abuse.md", None, "IAM-024"),
    ("playbooks/11-identity-ad-kerberos/suspicious-ldap-enumeration.md", None, "IAM-025"),

    ("playbooks/12-endpoint-execution/malware-detection-generic-av-edr-alert.md", None, "EP-001"),
    ...
    ("playbooks/12-endpoint-execution/powershell-spawned-by-an-office-application.md", None, "EP-006"),
    ...
    ("playbooks/12-endpoint-execution/certutil-abuse-download-decode.md", None, "EP-010"),
    ...
    ("playbooks/14-network/proxy-avoidance-tooling.md", "NET-14", "NW-012"),
    ...
    ("playbooks/16-email/credential-phishing.md", None, "EML-007"),
    ("playbooks/16-email/internal-compromised-account-phishing.md", None, "EML-008"),
    ...
    ("playbooks/17-cloud/public-storage-bucket-exposure.md", None, "CLD-004"),
    ...
    ("playbooks/17-cloud/cloud-audit-logging-disabled.md", None, "CLD-010"),
    ...
    ("playbooks/17-cloud/storage-based-exfiltration.md", None, "CLD-014"),
    ("playbooks/17-cloud/suspicious-api-call-sequences.md", "CLD-17.15", "CLD-015"),
    ("playbooks/17-cloud/cloud-shell-abuse.md", None, "CLD-016"),
    ...
    ("playbooks/18-ai-security/prompt-injection.md", None, "AI-001"),
    ...
    ("playbooks/18-ai-security/knowledge-base-poisoning.md", None, "AI-010"),
    ...
    ("playbooks/18-ai-security/model-connected-tool-misuse.md", None, "AI-020"),
    ...
    ("playbooks/18-ai-security/00-malicious-file-uploaded-into-ai-system.md", None, "AI-025"),
    ...
    ("playbooks/19-insider/printing-of-sensitive-files.md", None, "INS-007"),
    ("playbooks/19-insider/unusual-database-access.md", "INSIDER-08", "INS-008"),
    ("playbooks/19-insider/departing-employee-activity.md", None, "INS-009"),
    ...
    ("playbooks/20-data-exfiltration-master-playbook.md", None, "EXF-001"),
    ("playbooks/21-ransomware-master-playbook.md", "RAN-MASTER-21", "RAN-001"),
    ("playbooks/22-malware-master-playbook.md", None, "MAL-001"),
]
...
for rel_path, old_id, new_id in MIGRATIONS:
    if old_id is None:
        continue
    target_frag = rel_path
    found_line = False
    for i, line in enumerate(lines):
        if target_frag in line:
            found_line = True
            ...
            break
    if not found_line:
        notfound.append(rel_path)

with open(BOOK_INDEX, "w", encoding="utf-8") as f:
    f.writelines(lines)

print("Replacements made:", changed)
print("Link lines not found in BOOK-INDEX.md:", notfound)
